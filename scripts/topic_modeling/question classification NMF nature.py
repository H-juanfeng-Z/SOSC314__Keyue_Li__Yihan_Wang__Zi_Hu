...
OUTPUT_DIR = "nmf_results_natural_language_2to20"
...
for K in K_VALUES:
    ...
    # ========================================================
    # 7A. Save top words for each topic
    # ========================================================
    ...
    for topic_idx in range(K):
        ...
        for rank, word_idx in enumerate(
            top_indices,
            start=1
        ):
    ...
    # ========================================================
    # 7C. Save document-topic assignments
    # ========================================================
